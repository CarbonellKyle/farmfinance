    ...
    <div class="content">
        <div class="row">
            <div class="col-md-8">
                ...
                <form class="col-md-12" action="{{ route('yield.addSubmit') }}" method="POST">
                    @csrf
                    ...
                    <div class="card-header">
                        <h5 class="title text-center">{{ __('Record Harvest') }}</h5>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    <input type="number" name="quantity" class="form-control" placeholder="Quantity in kg" required>
                                </div>
