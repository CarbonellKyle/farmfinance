                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                @if(!isset($inactive))
                                <span><strong style="opacity: 0.5">Total Yields: </strong><span class="btn btn-sm btn-info"> {{ $total }} </span></span>
                                @endif
                            </div>
                        </div>
                        <div class="row mt-4">
                            <div class="col-lg-3">
                                <a class="btn btn-primary text-light" href="{{ route('yield.add') }}" <?php if(isset($inactive)){ ?> disabled <?php } ?> >
                                    <i class="nc-icon nc-shop text-light"></i>
                                    Record Harvest
                                </a>
                            </div>
                            <div class="col-lg-5">
                        ...
                        @if($monthly_count==0)
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                    @foreach ($monthly_yields as $yield)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a class="text-danger" href="/yields/delete/{{ $yield->yield_id }}">
                                ...
                                <div class="float-right mr-4">{{ $monthly_yields->links("pagination::bootstrap-4") }}</div>
                            </div>
                        @endif
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        @if($numRows==0)
                            ...
                            <div class="table-responsive">
                                ...
                                <div class="float-right mr-4">{{ $yields->links("pagination::bootstrap-4") }}</div>
                            </div>
                        @endif
                    </div>
                </div>
