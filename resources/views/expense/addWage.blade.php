        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="card-header ">
                    ...
                    <a class="btn btn-info text-light" href="{{ route('expense.laborwage') }}">
                ...
                <form class="col-md-12" action="{{ route('expense.addWageSubmit') }}" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    <input type="number" name="wage" class="form-control" placeholder="Amount in Pesos" required>
                                </div>
                                @if ($errors->has('wage'))
                                    <span class="invalid-feedback" style="display: block;" role="alert">
                    ...
                    <div class="card-footer">
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <button type="submit" class="btn btn-info btn-round">{{ __('Record Payment') }}</button>
                            </div>
                        </div>
                    </div>
            </form>
