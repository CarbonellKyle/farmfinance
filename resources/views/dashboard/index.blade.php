            ...
            <div class="col-md-6 col-sm-6">
                <div class="card card-stats" style="min-height: 180px">
                    <form method="POST" action="{{ route('reminder.update') }}">
                        ...
                        <div class="card-body">
                            <input type="hidden" name="id" value="{{ $reminder->appdata_id }}">
                            <input type="text" id="note" name="reminder" value="{{ $reminder->value }}"  class="form-control" style="display: none" placeholder="You can write some reminders here!">
