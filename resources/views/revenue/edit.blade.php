                ...
                <form class="col-md-12" action="{{ route('revenue.update') }}" method="POST"
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    <input type="text" id="q" name="quantity" class="form-control" placeholder="Quantity in kg" value="{{ $revenue->quantity }}" required>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    <input type="text" id="p" name="price_per_unit" class="form-control" placeholder="Price per unit" value="{{ $revenue->price_per_unit }}" required>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    <input type="text" id="t" for="p q" name="total_price" class="form-control" placeholder="Total Price" value="{{ $revenue->total_price }}" required>
                                </div>
