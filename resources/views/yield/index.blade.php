                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                @if(!isset($inactive))
                                <span><strong style="opacity: 0.5">Total Yields: </strong><span class="btn btn-success"> {{ $total }} </span></span>
                                @endif
                            </div>
                        </div>
                        <div class="row mt-4">
                            <div class="col-lg-3">
                                <a class="btn btn-info text-light" href="{{ route('yield.add') }}" <?php if(isset($inactive)){ ?> disabled <?php } ?> >
