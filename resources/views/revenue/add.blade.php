                ...
                <form class="col-md-12" action="{{ route('revenue.addSubmit') }}" method="POST"
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    <input type="number" id="q" name="quantity" class="form-control" placeholder="Quantity" required>
                                </div>
                    ...
                    <div class="card-footer">
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <button type="submit" class="btn btn-info btn-round">{{ __('Record Sale') }}</button>
                            </div>
                        </div>
                    </div>
            </form>
